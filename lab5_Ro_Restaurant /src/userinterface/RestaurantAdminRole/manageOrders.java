...
public class manageOrders extends javax.swing.JPanel {
    ...
    ArrayList<finalOrderModel> ordersList;
    ...
    private void initComponents() {
        ...
        statusOrders.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer", "Item", "status", "Delivery", "Remark", "OrderId", "Order date"
            }
        ));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnAssignDel, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(delCusto)
                                    .addComponent(delList, 0, 187, Short.MAX_VALUE)
                                    .addComponent(delDropDown, 0, 187, Short.MAX_VALUE)
                                    .addComponent(delItem))))
                        .addGap(0, 350, Short.MAX_VALUE)))
                .addContainerGap())
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {delCusto, delDropDown, delItem, delList});
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnAssignDel, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jButton1))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {delCusto, delDropDown, delItem, delList});
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        if(resto.getAcceptedOrders() == null)
            resto.setAcceptedOrders(new ArrayList<finalOrderModel>());
        ArrayList<finalOrderModel> orders = resto.getAcceptedOrders();
        rd = ecosystem.getRestaurantDirectory();
        int orderId = rd.generateOrderId();
        finalOrderModel fo = new finalOrderModel();
